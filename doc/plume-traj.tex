...
\end{itemize}
Increasing the total number of parcels (via larger \path{--n-columns} and/or \path{--n-vert}) generally reduces sampling noise and yields more stable, converged results, at the cost of longer runtimes.
