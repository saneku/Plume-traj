...
\begin{itemize}
    ...
    \item \path{--trajectory-emission-time-figure}: Optional trajectory map colored by emission time (hours since the emission reference time; typically \path{--emission-start} when provided).
