...
![Figure2](./doc/Fig2.png)
Backward-trajectory reconstruction (Plume-traj). Ash (left) and SO2 (right) show seeds, time-colored trajectories, and arrival heights; black contours show threshold 0.1; red triangle marks Hayli Gubbi volcano.
---
